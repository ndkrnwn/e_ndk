<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 fontpoppins"><i class="fab fa-wpforms"></i> <b>E - NDK </b><small><i class="fa fa-angle-double-right"></i> Form Copy Data</small></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">E - NDK</a></li>
                        <li class="breadcrumb-item active">Copy Data</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card card-lightblue card-outline">
                    ...
                    <form action="<?= site_url('entry/process') ?>" method="POST" class="form-horizontal">
                        <div class="card-body fontpoppins-input">
                            <h6 style="color: black;padding-top:5px;padding-bottom:5px;" class="text-bold">Form Copy Data</h6>
                            <div class="row">
                                <div class="col-lg-4">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 ">
                                    ...
                                    <button type="submit" name="copy" class="btn btn-secondary btn-sm col-sm-3">Submit</button>
                                </div>
                                <div class="col-sm-6">
                                </div>
                            </div>
