<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 fontpoppins"><i class="fab fa-wpforms"></i> <b>E - NDK </b><small><i class="fa fa-angle-double-right"></i> Form Entry Data</small></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card card-lightblue card-outline">
                    ...
                    <form action="<?= site_url('entry/process') ?>" method="POST" class="form-horizontal">
                        <div class="card-body fontpoppins-input">
                            <h6 style="color: black;padding-top:5px;padding-bottom:5px;" class="text-bold">Form Entry Data</h6>
                            <div class="row">
                                <div class="col-lg-4">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group date" id="tgl_ndk" data-target-input="nearest">
                                                    <input type="text" class="form-control form-control-sm input-area datetimepicker-input" name="tgl_ndk" data-target="#tgl_ndk" value="<?= $date ?>" required />
                                                    <label class="label">Tanggal NDK</label>
                                                    <div class="input-group-append" data-target="#tgl_ndk" data-toggle="datetimepicker">
                                    ...
                                    <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group date" id="tgl_inv" data-target-input="nearest">
                                                    <input type="text" class="form-control form-control-sm input-area datetimepicker-input" name="tgl_inv" data-target="#tgl_inv" />
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="input-group">
                                                            <select class="form-control form-control-sm input-area" name="ppn_type" id="ppn_type">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <select required class="form-control form-control-sm input-area" id="pt" name="pt" type="text">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm input-area" id="invoice_no" name="invoice_no">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="input-group">
                                                            <select class="form-control form-control-sm input-area" name="pph_type" id="pph_type">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <select class="form-control form-control-sm input-area" id="currency_select" name="mata_uang" type="text" required>
                                                            <option value="1"> Rp - Rupiah </option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" min="0" step="0.01" value="0" class="form-control form-control-sm input-area" name="potongan" id="potongan">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <select required class="form-control form-control-sm input-area" id="dari" name="dari" type="text">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" min="0" step="0.01" class="form-control form-control-sm input-area" name="nilai_ndk" id="nilai_ndk" required>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" min="0" step="0.01" value="0" class="form-control form-control-sm input-area" name="materai" id="materai">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <select class="form-control form-control-sm input-area" id="metode" name="metode" type="text" required>
                                                        ...
                                                        <option value="C"> 1 - Cash</option>
                                                        <option value="T"> 2 - Transfer</option>
                                                    </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm input-area" id="nama_penerima" name="nama_penerima" required>
                                ...
                                <div class="col-lg-4" style="display: none;" id="nrFieldRow">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm input-area" id="no_rekening" name="no_rekening">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <textarea class="form-control form-control-sm input-area" name="perihal" id="perihal" style="height: 100px;" required></textarea>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group">
                                                    <textarea class="form-control form-control-sm input-area" id="ket" name="ket" style="height: 100px;"></textarea>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <?php
                                                if ($this->fungsi->user_login()->dept_code == 'ACT') {
                                                    $diusulkan_oleh_value = "Ahmad Al Mukhlis";
                                                } elseif ($this->fungsi->user_login()->dept_code == 'COM') {
                                                    $diusulkan_oleh_value = "Donny Wong";
                                                }elseif ($this->fungsi->user_login()->dept_code == 'PUR') {
                                                    $diusulkan_oleh_value = "Donny Wong";
                                                } else {
                                                    $diusulkan_oleh_value = $this->session->userdata('ses_name');
                                                }
                                                ?>
                                                <div class="input-group">
                                                    <input type="text" required class="form-control form-control-sm input-area" name="diusulkan_oleh" value="<?= $diusulkan_oleh_value; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <?php
                                                if ($this->fungsi->user_login()->dept_code == 'ACT') {
                                                    $jbtn_usul_value = "Accounting Asstman";
                                                } elseif ($this->fungsi->user_login()->dept_code == 'COM') {
                                                    $jbtn_usul_value = "Ast. Manager";
                                                }elseif ($this->fungsi->user_login()->dept_code == 'PUR') {
                                                    $jbtn_usul_value = "Ast. Manager";
                                                } else {
                                                    $jbtn_usul_value = $this->session->userdata('ses_jbtn');
                                                }
                                                ?>
                                                <div class="input-group">
                                                    <input type="text" required class="form-control form-control-sm input-area" name="jbtn_usul" value="<?= $jbtn_usul_value; ?>">
                            ...
                            <!-- Approver Field -->
                            <!-- <h6 style="color: black;padding-top:5px;padding-bottom:5px;" class="text-bold">Approver</h6> -->
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <?php
                                                if ($this->fungsi->user_login()->dept_code == 'ACT') {
                                                    $setuju1_value = "Andri Gunawan";
                                                } elseif ($this->fungsi->user_login()->dept_code == 'COM') {
                                                    $setuju1_value = "Jap Kha Wui";
                                                }elseif ($this->fungsi->user_login()->dept_code == 'PUR') {
                                                    $setuju1_value = "Andryes Lim";
                                                } else {
                                                    $setuju1_value = "";
                                                }
                                                ?>
                                                <div class="input-group">
                                                    <input type="text" required class="form-control form-control-sm input-area" name="setuju1" value="<?= $setuju1_value; ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <?php
                                                if ($this->fungsi->user_login()->dept_code == 'ACT') {
                                                    $jbtn_setuju1_value = "Manager Accounting";
                                                } elseif ($this->fungsi->user_login()->dept_code == 'COM') {
                                                    $jbtn_setuju1_value = "Manager";
                                                }elseif ($this->fungsi->user_login()->dept_code == 'PUR') {
                                                    $jbtn_setuju1_value = "Manager Purchasing";
                                                } else {
                                                    $jbtn_setuju1_value = "";
                                                }
                                                ?>
                                                <div class="input-group">
                                                    <input type="text" required class="form-control form-control-sm input-area" name="jbtn_setuju1" value="<?= $jbtn_setuju1_value; ?>">
                                                    <label class="label">Jabatan</label>
                                                </div>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-10 col-md-10 col-sm-10">
                                                <div class="input-group date" id="tgl_setuju1" data-target-input="nearest">
                                                    <input type="text" class="form-control form-control-sm input-area datetimepicker-input " name="tgl_setuju1" data-target="#tgl_setuju1" />
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm input-area" name="setuju2">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm input-area" name="jbtn_setuju2">
                                                        <label class="label">Jabatan</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group date" id="tgl_setuju2" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm input-area datetimepicker-input " name="tgl_setuju2" data-target="#tgl_setuju2" />
                                                        <label class="label">Tanggal Disetujui</label>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm input-area" name="konfirm1">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm input-area" name="jbtn_konfirm1">
                                                        <label class="label">Jabatan</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group date" id="tgl_konfirm1" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm input-area datetimepicker-input " name="tgl_konfirm1" data-target="#tgl_konfirm1" />
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm input-area" name="konfirm2">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control form-control-sm input-area" name="jbtn_konfirm2">
                                                        <label class="label">Jabatan</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-10 col-md-10 col-sm-10">
                                                    <div class="input-group date" id="tgl_konfirm2" data-target-input="nearest">
                                                        <input type="text" class="form-control form-control-sm input-area datetimepicker-input " name="tgl_konfirm2" data-target="#tgl_konfirm2" />
                                                        <label class="label">Tanggal Dikonfirmasi</label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 ">
                                    ...
                                    <button type="submit" name="add" class="btn btn-secondary btn-sm col-sm-3">Submit</button>
                                </div>
                                <div class="col-sm-6">
                                </div>
                            </div>
