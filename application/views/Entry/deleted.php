<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 fontpoppins"><i class="fab fa-wpforms"></i> <b>E - NDK </b><small><i class="fa fa-angle-double-right"></i> List Deleted Data </small></h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">E - NDK</a></li>
                        <li class="breadcrumb-item active">List Deleted Data </li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="card card-lightblue card-outline fontpoppins-index">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="db_delete" class="table table-bordered table-hover table-sm small">
                            <thead>
                                <tr>
